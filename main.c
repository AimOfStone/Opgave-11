/*=============================================================================
*                                   Playlist
*              https://c-programming.aydos.de/week11/playlist.html
*  gcc .\opgave-11\main.c .\opgave-11\single_linked_list.c -o
* .\opgave-11\balls.exe
*==============================================================================*/
...
Node **load_file(const char *filename, Node **list) {
	...
	while (fgets(line, TRACK_TITLE_SIZE, f) != NULL	)
	{
...
{
	FILE *output_file = fopen(filename, "w"); //set as write file
	...
	current = current->next; //hop videre i listen
	}
	// YOUR CODE HERE
...
int main() {
	...
	Use the template below and only provide code in YOUR CODE HERE blocks.

	Document your project, but you don’t have to provide a flowchart.

	Content in playlist.txt should be transformed and written to playlist-out.txt, so that you get the following output.
	This modification is caused by highlighted lines in main.c.
